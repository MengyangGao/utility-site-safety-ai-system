...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "ui.unique_persons": "Unique persons",
        "ui.by_risk_level": "By risk level",
        "ui.by_event_type": "By event type",
        "ui.inference_complete": "Inference complete",
        "ui.page_caption": "Prototype decision-support demo for utility and construction safety monitoring. Not certified for safety-critical deployment.",
        "ui.confidence_floors_caption": "Per-class confidence floors are applied automatically (e.g. gloves 0.15, helmet 0.35) so low-confidence false positives are suppressed while rare PPE classes are still recovered.",
    ...
    "zh-hans": {
        ...
        "ui.page_caption": "面向公用事业和施工现场安全监控的决策支持演示原型。未通过安全关键部署认证。",
        "ui.confidence_floors_caption": "自动应用每类置信度下限（例如手套 0.15、安全帽 0.35），在抑制低置信度误报的同时仍能召回稀有 PPE 类别。",
    ...
    "zh-hant": {
        ...
        "ui.page_caption": "面向公用事業和施工現場安全監控的決策支援演示原型。未通過安全關鍵部署認證。",
        "ui.confidence_floors_caption": "自動套用每類置信度下限（例如手套 0.15、安全帽 0.35），在抑制低置信度誤報的同時仍能召回稀有 PPE 類別。",
